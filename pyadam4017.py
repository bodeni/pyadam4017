...
if len(scan) == 0:
    ...
    # Uncomment next 2 lines for test warning sound on Linux machine.
    # os.system(
...
ser_port = scan[0]
ser = serial.Serial(port=ser_port, timeout=0.08)
...
try:
    ...
    head = 'Time;Chanel 0;Chanel 1;Chanel 2;Chanel 3;Chanel 4;' + \
           'Chanel 5;Chanel 6;Chanel 7;Chanel 8;Chanel 9;Chanel 10;' + \
           'Chanel 11;Chanel 12;Chanel 13;Chanel 14;Chanel 15;\n'
    file_csv.write(head)
    file_csv.close()
    ...
    while True:
        ...
        while i <= 60:
            ...
            full_line = time_current + \
                ';' + line1[1:8] + ';' + line1[8:15] + \
                ';' + line1[15:22] + ';' + line1[22:29] + \
                ';' + line1[29:36] + ';' + line1[36:43] + \
                ';' + line1[43:50] + ';' + line1[50:57] + \
                ';' + line2[1:8] + ';' + line2[8:15] + \
                ';' + line2[15:22] + ';' + line2[22:29] + \
                ';' + line2[29:36] + ';' + line2[36:43] + \
                ';' + line2[43:50] + ';' + line2[50:57] + '\n'
    ...
    os.system(
        "sudo sh -c 'echo 1 > /sys/class/leds/orangepi:red:status/brightness'")
    # Uncomment next 2 lines for warning sound on Linux machine.
    # os.system(
    #     "(speaker-test -t sine -f 1000) & pid=$! ; sleep 0.2s ; kill -9 $pid")
    ...
    os.system(
        "sudo sh -c 'echo 1 > /sys/class/leds/orangepi:red:status/brightness'")
    # Uncomment next 5 lines for test warning sound on Linux machine.
    # os.system(
    #     "(speaker-test -t sine -f 1000) & pid=$! ; sleep 0.2s ; kill -9 $pid")
    # time.sleep(0.4)
    # os.system(
